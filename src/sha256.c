/* sha256.c — SHA-256 and HMAC-SHA256, no external dependencies. */
#include "sha256.h"
#include <string.h>
...
{
    uint8_t idig[SHA256_DIGEST_SIZE];
    sha256_final(&ctx->inner, idig);
    sha256_update(&ctx->outer, idig, SHA256_DIGEST_SIZE);
